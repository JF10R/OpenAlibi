...
const MESSAGES = {
  en: {
    ...
    ui: {
      ...
      densityHelp: 'A difficulty profile is applied automatically; this control overrides it.',
      ...
      rule6Title: 'Keep a working theory.',
      rule6Body: 'Pencil candidates and tentative placements are saved automatically and can be undone.',
  ...
  fr: {
    ...
    ui: {
      ...
      densityHelp: 'Un profil est appliqué selon la difficulté; ce réglage le remplace.',
      ...
      rule6Title: 'Conserve une théorie de travail.',
      rule6Body: 'Les candidats au crayon et placements d’essai sont sauvegardés automatiquement et peuvent être annulés.',
  ...
  es: {
    ...
    ui: {
      ...
      densityHelp: 'Se aplica un perfil según la dificultad; este control lo reemplaza.',
      ...
      rule6Title: 'Mantén una teoría de trabajo.',
      rule6Body: 'Los candidatos a lápiz y las posiciones de ensayo se guardan automáticamente y se pueden deshacer.',
