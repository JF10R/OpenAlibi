...
const MESSAGES = {
  en: {
    ...
    ui: {
      ...
      newGrid: 'New grid',
      shareChallenge: 'Share',
      generate: 'Generate a unique case',
      objectLegendButton: 'Legend',
      objectLegendTitle: 'Object legend',
      objectLegendIntro: 'Every object that may appear on the map. Some can hold a character; others block their cells.',
      objectLegendOccupiable: 'A character may stand on this object.',
      objectLegendBlocking: 'This object blocks its cell or cells.',
      ...
      planning: 'Hypothesis mode',
      planningTitle: 'Hypothesis workspace',
      planningIntro: 'Mark generic exclusions, keep pencil candidates, try placements, or save alternate theories.',
      modePlace: 'Place',
      modeMark: 'Mark ×',
    ...
    status: {
      ...
      challengeCopied: 'Versioned challenge link copied. It contains the exact seed and case settings.',
  ...
  fr: {
    ...
    ui: {
      ...
      shareChallenge: 'Partager',
      generate: 'Générer un cas unique',
      objectLegendButton: 'Légende',
      objectLegendTitle: 'Légende des objets',
      objectLegendIntro: 'Tous les objets qui peuvent apparaître sur le plan. Certains peuvent accueillir un personnage; les autres bloquent leurs cases.',
      objectLegendOccupiable: 'Un personnage peut être placé sur cet objet.',
      objectLegendBlocking: 'Cet objet bloque sa ou ses cases.',
      ...
      planning: 'Mode Hypothèse',
      planningTitle: 'Espace d’hypothèse',
      planningIntro: 'Marquez des exclusions génériques, notez des candidats, essayez des placements ou sauvegardez plusieurs hypothèses.',
      modePlace: 'Placer',
      modeMark: 'Marquer ×',
    ...
    status: {
      ...
      challengeCopied: 'Lien versionné du défi copié. Il contient le seed exact et les paramètres du dossier.',
  ...
  es: {
    ...
    ui: {
      ...
      shareChallenge: 'Compartir',
      generate: 'Generar un caso único',
      objectLegendButton: 'Leyenda',
      objectLegendTitle: 'Leyenda de objetos',
      objectLegendIntro: 'Todos los objetos que pueden aparecer en el plano. Algunos pueden contener un personaje; los demás bloquean sus casillas.',
      objectLegendOccupiable: 'Se puede colocar un personaje sobre este objeto.',
      objectLegendBlocking: 'Este objeto bloquea su casilla o sus casillas.',
      ...
      planning: 'Modo hipótesis',
      planningTitle: 'Espacio de hipótesis',
      planningIntro: 'Marca exclusiones genéricas, anota candidatos, prueba posiciones o guarda teorías alternativas.',
      modePlace: 'Colocar',
      modeMark: 'Marcar ×',
      modeCandidate: 'Lápiz',
    ...
    status: {
      ...
      challengeCopied: 'Enlace versionado del reto copiado. Contiene la seed exacta y los ajustes del caso.',
