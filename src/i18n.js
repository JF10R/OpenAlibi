...
const MESSAGES = {
  en: {
    ...
    clues: {
      ...
      evidenceTrailOne: 'The victim was found at {cell}. The murderer was exactly one cell from {object}.',
      evidenceTrailMany: 'The victim was found at {cell}. The murderer was exactly {distance} cells from {object}.',
      restrictedAccess: 'The victim was found at {cell}. The murderer was the only person in {room}, directly accessible from the victim’s room.',
    ...
    ui: {
      ...
      boardRuleCoPresence: 'Room alibi: the murderer is alone with the victim.',
      boardRuleEvidenceTrail: 'Evidence trail: exact distance from material evidence identifies the murderer.',
      boardRuleRestrictedAccess: 'Restricted access: a unique occupant of an adjoining room identifies the murderer.',
  ...
  fr: {
    ...
    clues: {
      ...
      evidenceTrailOne: 'La victime a été trouvée en {cell}. Le meurtrier se trouvait exactement à une case {object}.',
      evidenceTrailMany: 'La victime a été trouvée en {cell}. Le meurtrier se trouvait exactement à {distance} cases {object}.',
      restrictedAccess: 'La victime a été trouvée en {cell}. Le meurtrier était la seule personne dans {room}, directement accessible depuis la pièce de la victime.',
    ...
    ui: {
      ...
      boardRuleCoPresence: 'Alibi de pièce : le meurtrier est seul avec la victime.',
      boardRuleEvidenceTrail: 'Chaîne de preuves : une distance exacte d’un objet matériel identifie le meurtrier.',
      boardRuleRestrictedAccess: 'Accès restreint : l’unique occupant d’une pièce adjacente identifie le meurtrier.',
  ...
  es: {
    ...
    clues: {
      ...
      evidenceTrailOne: 'La víctima fue encontrada en {cell}. El asesino estaba exactamente a una casilla de {object}.',
      evidenceTrailMany: 'La víctima fue encontrada en {cell}. El asesino estaba exactamente a {distance} casillas de {object}.',
      restrictedAccess: 'La víctima fue encontrada en {cell}. El asesino era la única persona en {room}, con acceso directo desde la habitación de la víctima.',
    ...
    ui: {
      ...
      boardRuleCoPresence: 'Coartada de habitación: el asesino está a solas con la víctima.',
      boardRuleEvidenceTrail: 'Cadena de pruebas: una distancia exacta de una prueba material identifica al asesino.',
      boardRuleRestrictedAccess: 'Acceso restringido: el único ocupante de una habitación contigua identifica al asesino.',
